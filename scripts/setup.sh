...
echo ""
echo "  Option B (full, ~90GB, opt-in — not run automatically by this script):"
echo "    bash $BENCHMARK_DIR/scripts/download_reference_dbs.sh $DB_DIR"
echo "    Covers refGene + gnomAD 4.1 exome + ClinVar + avsnp151 + dbNSFP 4.7a"
echo "    (needed for Tier 1/2 AND Tier 5's PP3/BP4/PS1/PM5 computational evidence)"
echo ""
